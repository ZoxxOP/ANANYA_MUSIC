...
BOT_USERNAME = getenv("BOT_USERNAME" , "TheAnanyaBot")
BOT_NAME = getenv("BOT_NAME" , "˹Aɴᴀɴʏᴀ ꭙ ᴍᴜsɪᴄ˼ ㋛︎")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ZoxxOP/ANANYA_MUSIC",)
