...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("𝐀𝐤𝐚𝐬𝐡 𝐃𝐚𝐤𝐬𝐡𝐰𝐚𝐧𝐬𝐡𝐢", url="https://t.me/WTF_NoHope")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/AnanyaBotSupport"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/AnanyaBots"),
        ],
        [
