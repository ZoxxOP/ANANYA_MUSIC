...
EVAA = [
    [
        InlineKeyboardButton(text="✙ ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ ✙", url=f"https://t.me/@qenbot?startgroup=true"),
    ],
]
...
bg_path = "ANANYA_MUSIC/assets/AnanyaINFO.png"
font_path = "ANANYA_MUSIC/assets/hiroko.ttf"
...
❖ ϻᴧᴅє ʙʏ  ➛ [˹ᴀɴᴀɴʏᴀ ʙᴏᴛs˼ 💞](https://t.me/WTF_NoHope)
▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭
