...
from ANANYA_MUSIC.utils import help_pannel
from ANANYA_MUSIC.utils.database import get_lang
from ANANYA_MUSIC.utils.decorators.language import LanguageStart, languageCB
from ANANYA_MUSIC.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from ANANYA_MUSIC.help.buttons import BUTTONS
from ANANYA_MUSIC.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_Ananya, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
