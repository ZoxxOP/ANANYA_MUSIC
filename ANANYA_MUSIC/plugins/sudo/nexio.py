import requests
import random
from ANANYA_MUSIC import app, userbot
from ANANYA_MUSIC.misc import SUDOERS
from pyrogram import * 
from pyrogram.types import *
from ANANYA_MUSIC.utils.Ananya_BAN import admin_filter
...
@app.on_message(filters.command(["lkash", "nanya"], prefixes=["A", "A"]) & admin_filter)
