...
from ANANYA_MUSIC.utils.inline import supp_markup
...
async def ping_com(client, message: Message, _):
    PING_IMG_URL = "https://files.catbox.moe/gk3nc8.jpg"
    ...
    reply_markup=InlineKeyboardMarkup(
        ...
        [
            InlineKeyboardButton(
                text="⌯ sᴜᴘᴘᴏʀᴛ ⌯", url=f"https://t.me/AnanyaBotSupport",
            ),
            InlineKeyboardButton(
                text="⌯ ᴜᴘᴅᴀᴛᴇ ⌯", url=f"https://t.me/AnanyaBots",
            )
        ],
        [
            InlineKeyboardButton(
