...
from ANANYA_MUSIC.mongo.readable_time import get_readable_time
from ANANYA_MUSIC.mongo.afkdb import add_afk, is_afk, remove_afk
import random 
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup

NEXIO = [
        [
            InlineKeyboardButton(text="• ᴀᴧᴅᴅ ϻᴇ ʙᴧʙʏ •", url=f"https://t.me/TheAnanyaBot?startgroup=true"),
        ],
        ]
